...
import com.mind_era.knime.common.PublicConstants;
import com.mind_era.knime.common.util.file.OpenStream;
...
public class ImporterNodeModel extends NodeModel {
	...
	static final String CFGKEY_FILES = "com.mind_era.knime.hits.xls.files";

	/** The configuration key for the annotation file path. */
	static final String CFGKEY_ANNOTATION_FILE = "com.mind_era.knime.hits.xls.annot";
	...
	static final String CFGKEY_WELL_COUNT = "com.mind_era.knime.hits.wells";
	 ...
	 * count).
	 */
	static final String CFGKEY_PLATE_COUNT = "com.mind_era.knime.hits.plates";
	/** The default value for the plate count */
	static final int DEFAULT_PLATE_COUNT = 1;

	/** The configuration key for the replicate count. */
	static final String CFGKEY_REPLICATE_COUNT = "com.mind_era.knime.hits.replicates";
