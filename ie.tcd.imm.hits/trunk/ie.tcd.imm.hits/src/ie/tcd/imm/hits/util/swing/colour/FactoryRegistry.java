...
public class FactoryRegistry {
	...
	// private final Map<Class<? extends ColourComputer>, ColourFactory<?>>
	// factories = new HashMap<Class<? extends ColourComputer>,
	// ColourFactory<?>>();
	...
	<Computer extends ColourComputer> ColourFactory<Computer> getFactory(
		...
		// return ret;
		@SuppressWarnings("unchecked")
		final ColourFactory<Computer> ret = (ColourFactory<Computer>) computer;
		return ret;
	}
