...
public class DendrogramNodeView extends HierarchicalClusterNodeView {
	...
	private final class SaveAs extends AbstractAction {
		...
		private final DendrogramPlotter dendrogramPlotter;
		private final ImageType type;

		private SaveAs(final String name,
				final DendrogramPlotter dendrogramPlotter, final ImageType type) {
			super(name);
			this.dendrogramPlotter = dendrogramPlotter;
			this.type = type;
		}
	...
	public DendrogramNodeView(final NodeModel nodeModel,
		...
		final JMenuItem exportPNG = new JMenuItem(new SaveAs(
				"Export view as PNG", dendrogramPlotter, ImageType.png));
		file.add(exportPNG);
		final JMenuItem exportSVG = new JMenuItem(new SaveAs(
				"Export view as SVG", dendrogramPlotter, ImageType.svg));
		file.add(exportSVG);
	}
}
