...
/**
 * <code>NodeFactory</code> for the "Subsets" Node.
 * Generates all possible subsets of the input.
 *
 * @author <a href="mailto:bakosg@tcd.ie">Gabor Bakos</a>
 */
public class SubsetsNodeFactory 
        extends NodeFactory<SubsetsNodeModel> {
    ...
    public NodeView<SubsetsNodeModel> createNodeView(final int viewIndex,
        ...
        return new SubsetsNodeView(nodeModel);
    }
