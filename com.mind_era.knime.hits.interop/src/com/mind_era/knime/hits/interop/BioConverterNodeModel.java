...
import com.mind_era.knime.hits.interop.BioConverterNodeDialog.ColumnType;
import com.mind_era.knime.hits.interop.BioConverterNodeDialog.DialogType;
import com.mind_era.knime.hits.interop.config.Default;
			...
			final SingleCellFactory factory = new SingleCellFactory(
				...
				private String evaluate(final String text,
					...
					if (leadingMatcher.matches()) {
						return com.mind_era.knime.common.util.Misc.addTrailing(Integer
