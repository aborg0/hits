 ...
 */
public class BioConverterNodePlugin extends Plugin {

	/** Make sure that this *always* matches the ID in plugin.xml. */
	public static final String PLUGIN_ID = "com.mind_era.knime.hits.interop";

	// The shared instance.
	private static BioConverterNodePlugin plugin;
	 ...
	 */
	public static BioConverterNodePlugin getDefault() {
		return plugin;
	}
