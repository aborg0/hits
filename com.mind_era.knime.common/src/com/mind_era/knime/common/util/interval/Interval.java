 ...
 */
package com.mind_era.knime.common.util.interval;
...
public interface Interval<Content extends Comparable<? super Content>> extends
	...
	public static final class DefaultInterval<Content extends Comparable<Content> & Serializable>
		 ...
		 * 
		 * @see
		 * com.mind_era.knime.common.util.interval.Interval#contains(java.lang.Comparable)
		 */
		@Override
		public boolean contains(final Content val) {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.mind_era.knime.common.util.interval.Interval#getHigh()
		 */
		@Override
		public Content getHigh() {
			return high;
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.mind_era.knime.common.util.interval.Interval#getLow()
		 */
		@Override
		public Content getLow() {
			return low;
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.mind_era.knime.common.util.interval.Interval#isClosedLow()
		 */
		@Override
		public boolean isClosedLow() {
			return closedLow;
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.mind_era.knime.common.util.interval.Interval#isClosedHigh()
		 */
		@Override
		public boolean isClosedHigh() {
			return closedHigh;
