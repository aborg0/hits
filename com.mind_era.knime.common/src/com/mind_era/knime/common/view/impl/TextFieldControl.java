...
//				}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.mind_era.knime.common.util.swing.VariableControl#getType()
	 */
	@Override
	public com.mind_era.knime.common.util.swing.VariableControl.ControlTypes getType() {
	 ...
	 * 
	 * @see
	 * com.mind_era.knime.common.view.impl.AbstractVariableControl#notifyChange(
	 * java.awt.event.MouseListener,
	 * com.mind_era.knime.common.view.impl.AbstractVariableControl.Change)
	 */
	@Override
	protected void notifyChange(
			MouseListener listener,
			com.mind_era.knime.common.view.impl.AbstractVariableControl.Change change) {
		switch (change) {
		case add:
