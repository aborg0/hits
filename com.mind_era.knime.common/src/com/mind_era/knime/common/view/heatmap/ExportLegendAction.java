...
import com.mind_era.knime.common.util.swing.colour.ColourFactory;
import com.mind_era.knime.common.util.swing.colour.ColourLegend;
import com.mind_era.knime.common.util.swing.colour.ColourSelector;
import com.mind_era.knime.common.util.swing.colour.FactoryRegistry;
import com.mind_era.knime.common.util.swing.colour.Orientation;
...
public class ExportLegendAction<ModelType extends ColourComputer> extends
	...
	private JList<StatTypes> statTypes;
	...
	protected Traversable<JComponent, String> createTraversable(
		...
		return new Traversable<JComponent, String>() {
			...
			public void traverse(final Callable<?> callable) {
				...
				final Set<String> selectedParameters = new HashSet<String>(parameters.getSelectedValuesList());
				final Set<StatTypes> selectedStatTypes = new HashSet<StatTypes>(statTypes.getSelectedValuesList());
	...
	protected JComponent createAdditionalControls() {
		...
		final Map<String, Collection<StatTypes>> modelKeys = colourSelector
				.getModel().getModelKeys();
		parameters = new JList<String>(new Vector<>(modelKeys.keySet()));
		parameters
		...
		statTypes = new JList<StatTypes>(new Vector<>(presentStatTypes));
		statTypes
				.setSelectionMode(ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
