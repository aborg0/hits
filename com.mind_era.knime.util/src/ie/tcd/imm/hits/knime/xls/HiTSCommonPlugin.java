 ...
 */
public class HiTSCommonPlugin extends AbstractUIPlugin {

	//TODO I think this is no longer required
	/** Make sure that this *always* matches the ID in plugin.xml. */
	public static final String PLUGIN_ID = "ie.tcd.imm.hits.knime.xls";

	// The shared instance.
	private static HiTSCommonPlugin plugin;

	/**
	 * The constructor.
	 */
	@SuppressFBWarnings("ST")
	public HiTSCommonPlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static HiTSCommonPlugin getDefault() {
		return plugin;
	}
